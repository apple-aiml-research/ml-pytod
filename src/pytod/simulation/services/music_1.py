...
@register_command(service="Music_1")
class LookupSong(SearchCommand):
...
@register_command(service="Music_1")
class PlaySong(ConfirmedCommand):
    song_name: ConfirmedCommandArgument[str] = ConfirmedCommandArgument()
    artist: ConfirmedCommandArgument[str] = ConfirmedCommandArgument()
    playback_device: ConfirmedCommandArgument[str] = ConfirmedCommandArgument()
